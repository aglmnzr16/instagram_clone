  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
        options: const FirebaseOptions(
            apiKey: 'AIzaSyDNgi0_DDQxyvejPGPNUL-rh9SVzhJBk3c',
            appId: '1:849421460917:web:895335caebb91f0f12a5fc',
            messagingSenderId: '849421460917',
            projectId: 'instagram-agil',
            storageBucket: 'instagram-agil.appspot.com'));
  } else {
    await Firebase.initializeApp();
  }
  runApp(const MyApp());
